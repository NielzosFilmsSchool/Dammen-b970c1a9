...
class RegelControleur
{
                ...
                if ($spelerAanDeBeurt == "Blauw") {
                    if ($steen->getColor() == "blue") {
                        if ($i - 11 >= 0 && $i - 9 >= 0) {
                            ...
                            if ($vak_L->containsSteen()) {
                                return $this->vakDiagonaalTest($vak_L, $zet_id, "black", $i, $bord, 22);
                            }
                            if ($vak_R->containsSteen()) {
                                return $this->vakDiagonaalTest($vak_R, $zet_id, "black", $i, $bord, 18);
                            }
                        } else if ($i - 11 >= 0) {
                            $vak_L = $bord->getVakjes()[$i - 11];
                            if ($vak_L->containsSteen()) {
                    ...
                    if ($steen->getColor() == "black") {
                        if ($i + 11 < $vak_count && $i + 9 < $vak_count) {
                            ...
                            if ($vak_L->containsSteen()) {
                                return $this->vakDiagonaalTest($vak_L, $zet_id, "blue", $i, $bord, 22);
                            }
                            if ($vak_R->containsSteen()) {
                                return $this->vakDiagonaalTest($vak_R, $zet_id, "blue", $i, $bord, 18);
                            }
    ...
    private function vakDiagonaalTest($testVak, $zet_id, $kleur, $i, $bord, $offset)
    {
        ...
        if ($testSteen->getColor() == $kleur && $zet_id != $vak_L_id) {
            if ($kleur == "blue") {
                return $this->getSteenDiagonaal(-$offset, $bord, $i, $testVak);
            }
            if ($kleur == "black") {
                return $this->getSteenDiagonaal($offset, $bord, $i, $testVak);
            }
                ...
                if ($spelerAanDeBeurt == "Blauw") {
                    if ($steen->getColor() == "blue") {
                        if ($i - 11 >= 0 && $i - 9 >= 0) {
                            ...
                            if ($vak_L->containsSteen()) {
                                return $this->vakDiagonaalTestZonderZet($vak_L, "black", $i, $bord, 22);
                            }
                            if ($vak_R->containsSteen()) {
                                return $this->vakDiagonaalTestZonderZet($vak_R, "black", $i, $bord, 18);
                            }
                        } else if ($i - 11 >= 0) {
                            $vak_L = $bord->getVakjes()[$i - 11];
                            if ($vak_L->containsSteen()) {
                    ...
                    if ($steen->getColor() == "black") {
                        if ($i + 11 < $vak_count && $i + 9 < $vak_count) {
                            ...
                            if ($vak_L->containsSteen()) {
                                return $this->vakDiagonaalTestZonderZet($vak_L, "blue", $i, $bord, 22);
                            }
                            if ($vak_R->containsSteen()) {
                                return $this->vakDiagonaalTestZonderZet($vak_R, "blue", $i, $bord, 18);
                            }
                        } else if ($i + 11 < $vak_count) {
                            $vak_L = $bord->getVakjes()[$i + 11];
                            if ($vak_L->containsSteen()) {
